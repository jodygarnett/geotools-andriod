...
public class AbstractFactory implements Factory, RegisterableService {
     ...
     * </ul>
     */
    protected final Map<Object, Object> hints =
     ...
     */
    private final Map<Object, Object> unmodifiableHints =
     ...
     * @since 2.5
     */
    protected boolean addImplementationHints(final Hints map) {
        /*
        ...
        if (map != null) {
            for (final Map.Entry<?,?> entry : map.entrySet()) {
                ...
                //if (key instanceof RenderingHints.Key) {
                    ...
                    final Object old = hints.put(key, value);
     ...
     */
    public Map<Object,Object> getImplementationHints() {

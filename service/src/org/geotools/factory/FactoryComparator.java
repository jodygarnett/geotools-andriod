...
final class FactoryComparator {
    ...
    boolean compare(final Set<FactoryComparator> done) {
        if (done.add(this)) {
            final Map<Object, Object> m1 = f1.getImplementationHints();
            final Map<Object, Object> m2 = f2.getImplementationHints();
            if (m1.size() != m2.size()) {
                return false;
            }
            for (final Map.Entry<Object, Object> entry : m1.entrySet()) {
